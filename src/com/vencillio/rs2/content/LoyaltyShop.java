...
public class LoyaltyShop {
	...
	public static enum TitleButton {
		...
		COPYCAT(215007, PlayerTitle.create("Copycat", 0xB0720E, false), 25),
		KING(215015, PlayerTitle.create("King", 0xB0720E, false), 25),
		QUEEN(215023, PlayerTitle.create("Queen", 0xB0720E, false), 25),
		FAM(215031, PlayerTitle.create("Fam", 0xB0720E, false), 30),
		BROTHER(215039, PlayerTitle.create("Brother", 0xB0720E, false), 30),
		SISTER(215047, PlayerTitle.create("Sister", 0xB0720E, false), 30),
		OVERLOAD(215055, PlayerTitle.create("Overload", 0xB0720E, false), 30),
		THE(215063, PlayerTitle.create("The", 0xB0720E, false), 30),
		RICHIERICH(215071, PlayerTitle.create("RichieRich", 0xB0720E, false), 30),
		EMPEROR(215079, PlayerTitle.create("Emperor", 0xB0720E, false), 30),
		IMMORTAL(215087, PlayerTitle.create("Immortal", 0xB0720E, false), 30),
		...
		SWAGTASTIC(215111, PlayerTitle.create("Swagtastic", 0xB0720E, false), 30),
		GODLY(215119, PlayerTitle.create("Godly", 0xB0720E, false), 30),
		RESPECTED(215127, PlayerTitle.create("Respected", 0xB0720E, false), 30),
		THE_ONE(215135, PlayerTitle.create("The One", 0xB0720E, false), 30),
		HOLY(215143, PlayerTitle.create("Holy", 0xB0720E, false), 30),
		SKILLED(215151, PlayerTitle.create("Skilled", 0xB0720E, false), 30),
