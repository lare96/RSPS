...
public class Casket {
	...
	public static Chance<Item> SKILLING_LOOTS = new Chance<Item>(Arrays.asList(
			...
			//Uncommon Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2359, 1000)), //Mith bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2361, 1000)), //Addy bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2363, 1000)), //Rune bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1515, 1000)), //Yew log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1513, 1000)), //Magic log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1745, 1000)), //green leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2595, 1000)), //blue leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2507, 1000)), //red leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2509, 1000)), //black leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(257, 1000)), //Grimy ranarr
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3051, 1000)), //Grimy snapdragon
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(371, 1000)), //Raw swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(389, 1000)), //Raw manta
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(383, 1000)), //Raw shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11934, 1000)), //Raw dark crab
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11849, 125)), //mark of grace
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(5304, 500)), //torstol seeds


			//Rare Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2359, 1500)), //Mith bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2361, 1500)), //Addy bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2363, 1500)), //Rune bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1515, 1500)), //Yew log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1513, 1500)), //Magic log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1745, 1500)), //green leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2595, 1500)), //blue leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2507, 1500)), //red leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2509, 1500)), //black leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(257, 1500)), //Grimy ranarr
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3051, 1500)), //Grimy snapdragon
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(371, 1500)), //Raw swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(389, 1500)), //Raw manta
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(383, 1500)), //Raw shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11934, 1500)), //Raw dark crab
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11849, 175)), //mark of grace
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(5304, 750)), //torstol seeds

			//Very Rare Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2359, 2500)), //Mith bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2361, 2500)), //Addy bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2363, 2500)), //Rune bar
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1515, 2500)), //Yew log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1513, 2500)), //Magic log
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(1745, 2500)), //green leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2595, 2500)), //blue leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2507, 2500)), //red leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2509, 2500)), //black leather
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(257, 2500)), //Grimy ranarr
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3051, 2500)), //Grimy snapdragon
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(371, 2500)), //Raw swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(389, 2500)), //Raw manta
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(383, 2500)), //Raw shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11934, 2500)), //Raw dark crab
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(5304, 1000)), //torstol seeds
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11920, 1)), //d pick
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(6739, 1)) //d axe
	...
	public static Chance<Item> PVM_LOOTS = new Chance<Item>(Arrays.asList(
			...
			//Uncommon Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(362, 500)), //Tuna
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(380, 500)), //Lobster
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(374, 500)), //Swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(392, 500)), //Mantas
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(386, 500)), //Shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(7061, 500)), //Tuna potato
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2441, 250)), //Super str
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2437, 250)), //Super att
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2443, 250)), //Super def
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3025, 125)), //Super restore
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2453, 125)), //Antifires
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(892, 1000)), //rune arrows
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(9144, 750)), //rune bolts
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11726, 250)), //Super mage
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11722, 250)), //Super range


			//Rare Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(362, 1500)), //Tuna
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(380, 1500)), //Lobster
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(374, 1500)), //Swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(392, 1500)), //Mantas
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(386, 1500)), //Shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(7061, 1500)), //Tuna potato
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2441, 300)), //Super str
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2437, 300)), //Super att
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2443, 300)), //Super def
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3025, 175)), //Super restore
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2453, 175)), //Antifires
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(892, 1500)), //rune arrows
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(9144, 1000)), //rune bolts
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11726, 300)), //Super mage
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11722, 300)), //Super range

			//Very Rare Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(362, 2500)), //Tuna
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(380, 2500)), //Lobster
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(374, 2500)), //Swordfish
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(392, 2500)), //Mantas
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(386, 2500)), //Shark
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(7061, 2500)), //Tuna potato
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2441, 400)), //Super str
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2437, 400)), //Super att
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2443, 400)), //Super def
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(3025, 225)), //Super restore
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(2453, 200)), //Antifires
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(892, 5000)), //rune arrows
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11726, 400)), //Super mage
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11722, 400)) //Super range
