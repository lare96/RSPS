...
public class CrystalChest {
	...
	public static final Item[] UNCOMMON_CHEST_REWARDS = { new Item(ItemNames.ZAMORAK_PLATEBODY), new Item(ItemNames.ADAMANT_PLATEBODY), new Item(ItemNames.ADAMANT_PLATELEGS), new Item(ItemNames.ADAMANT_FULL_HELM), new Item(ItemNames.ZAMORAK_PLATELEGS), new Item(ItemNames.SARADOMIN_PLATEBODY), new Item(ItemNames.SARADOMIN_PLATELEGS), new Item(ItemNames.GUTHIX_PLATEBODY), new Item(ItemNames.GUTHIX_PLATELEGS), new Item(ItemNames.ZAMORAK_FULL_HELM), new Item(ItemNames.GUTHIX_FULL_HELM), new Item(ItemNames.SARADOMIN_FULL_HELM), new Item(ItemNames.ZAMORAK_KITESHIELD), new Item(ItemNames.GUTHIX_KITESHIELD), new Item(ItemNames.SARADOMIN_KITESHIELD), new Item(ItemNames.DRAGON_MED_HELM), new Item(ItemNames.DRAGON_PLATESKIRT), new Item(ItemNames.DRAGON_SQ_SHIELD), new Item(ItemNames.HELM_OF_NEITIZNOT), new Item(ItemNames.WARRIOR_HELM), new Item(ItemNames.ARCHER_HELM), new Item(ItemNames.FARSEER_HELM), new Item(ItemNames.RUNE_SCIMITAR), new Item(ItemNames.RUNE_2H_SWORD), new Item(ItemNames.DRAGON_DAGGER), new Item(ItemNames.DRAGON_SCIMITAR), new Item(ItemNames.DRAGON_MACE), new Item(ItemNames.DRAGON_BATTLEAXE),
