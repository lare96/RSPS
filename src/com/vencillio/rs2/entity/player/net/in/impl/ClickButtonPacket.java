...
import com.vencillio.rs2.content.interfaces.impl.*;
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		/* Bolt enchanting */
			...
			case 121028:
				...
				break;
			case 121032:
				player.getUpdateFlags().sendForceMessage("I have completed " + player.getPA().achievementCompleted() + " achievements");
				break;
			case 121033:
				player.getUpdateFlags().sendForceMessage("I have " + player.getAchievementsPoints() + " achievement points");
				break;
			case 114226:
			...
			case 24125:
				...
				break;
			case 24126:
				player.getAttributes().set("manual", (byte) 1);
				break;
			case 108005:
